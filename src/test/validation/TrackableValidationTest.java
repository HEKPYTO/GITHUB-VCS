...
class TrackableValidationTest {
    ...
    void shouldTrackValidFile() throws Exception {
        Path testFile = createFile("source.java", "content");
    ...
    void shouldRejectNonexistentFile() {
        String nonexistentFile = tempDir.resolve("missing.java").toString();
    ...
    void shouldIgnoreUntrackingNonexistentFile() {
        assertDoesNotThrow(() -> trackable.untrackFile("missing.java"));
    }
    ...
    void shouldHandleMultipleFileStatuses() throws Exception {
        Path file1 = createFile("model.java", "content1");
        Path file2 = createFile("view.java", "content2");
