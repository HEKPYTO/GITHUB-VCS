...
class VersionInfoSolutionTest {
    private VersionInfo versionInfo;
    private static final String TEST_MESSAGE = "Solution commit message";
    private static final String TEST_AUTHOR = "Solution Author";
    private Map<String, String> testFileHashes;

    @BeforeEach
    void setUp() {
        testFileHashes = new HashMap<>();
        testFileHashes.put("doc1.md", "sha1");
        testFileHashes.put("doc2.md", "sha2");
    ...
    void testVersionIdGeneration() {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            assertTrue(versionIds.add(versionId), "UUID collision found");
        }
    ...
    void testFileHashesDefensiveCopy() {
        ...
        returnedHashes.put("test.md", "sha256");
        returnedHashes.remove("doc1.md");
    ...
    void testConstructorDefensiveCopy() {
        testFileHashes.put("test.md", "sha256");
        Map<String, String> versionHashes = versionInfo.getFileHashes();
        assertEquals(2, versionHashes.size());
        assertTrue(versionHashes.containsKey("doc1.md"));
        assertTrue(versionHashes.containsKey("doc2.md"));
    }
    ...
    private static Stream<Arguments> provideSpecialMessages() {
        return Stream.of(
                Arguments.of((Object) "Solution message"),
                Arguments.of((Object) ""),
                Arguments.of((Object) null),
                Arguments.of((Object) "Solution chars: $#@%&*()"),
                Arguments.of((Object) "Solution unicode: こんにちは"),
                Arguments.of((Object) "Solution long: " + "b".repeat(1000))
        );
    }
}