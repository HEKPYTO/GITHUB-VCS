...
class FileTrackerSolutionTest {
    ...
    void trackFileBasic() throws Exception {
        Path file = createFile("Repository.kt", "data");
    ...
    void trackFileNonExistent() {
        assertThrows(VCSException.class, () ->
                fileTracker.trackFile(tempDir.resolve("missing.kt").toString()));
    }
    ...
    void untrackFileNotTracked() {
        assertDoesNotThrow(() -> fileTracker.untrackFile("missing.kt"));
    }
    ...
    void getTrackedFilesMultiple() throws Exception {
        Path file1 = createFile("Model.kt", "data1");
        Path file2 = createFile("Service.kt", "data2");
